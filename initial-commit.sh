...
git submodule add https://github.com/BurendoUK/burendo-githooks .githooks
...
git push https://${TF_VAR_github_token}:x-oauth-basic@github.com/BurendoUK/$NEW_REPO_NAME
